...
Numer dokumentu i e-mail są wymagane, e-mail musi mieć poprawny format, a zgoda musi być zaznaczona. Notatka staje się wymagana dla typu `Other` i nie może przekroczyć 200 znaków. Przekroczenie limitu pokazuję od razu, bez blokowania możliwości sprawdzenia ścieżki błędu. Po błędnym submit fokus trafia do pierwszego niepoprawnego pola.
